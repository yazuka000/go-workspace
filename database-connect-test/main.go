...
func main() {
	...
	conn, err := sql.Open("pgx", "host=localhost port=5432 dbname=database_connect_test user=takahashikazuya password=")
	if err != nil {
	...
	log.Println("QueryRows returns", id, firstName, lastName)
